        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Luxe CV est né d'une passion pour le Cap-Vert et d'une volonté d'offrir un service d'excellence aux investisseurs internationaux. 
              Nous sélectionnons rigoureusement les meilleures opportunités immobilières pour vous garantir un investissement sûr et rentable.
            </p>
          </div>
