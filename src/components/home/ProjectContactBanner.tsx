        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          <Reveal delay={0.2}>
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Votre vision, <span className="text-primary italic">notre expertise.</span>
            </h2>
          </Reveal>
            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-gray-900 uppercase tracking-widest">Prénom</label>
                  <Input 
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-gray-900 uppercase tracking-widest">Nom</label>
                  <Input 
                    className="h-14 bg-gray-100 border-gray-200 focus:bg-white focus:border-primary/20 rounded-xl text-lg text-gray-900 placeholder:text-gray-500 transition-all"
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-gray-900 uppercase tracking-widest">Contact</label>
                <Input 
                  className="h-14 bg-gray-100 border-gray-200 focus:bg-white focus:border-primary/20 rounded-xl text-lg text-gray-900 placeholder:text-gray-500 transition-all"
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-gray-900 uppercase tracking-widest">Votre Projet</label>
                <textarea 
                  ...
                  placeholder="Je souhaite investir dans..."
                />
              </div>

              <div className="pt-4 flex flex-col md:flex-row items-center justify-between gap-6">
                <p className="text-sm text-gray-400 text-center md:text-left">
                  En cliquant sur envoyer, vous acceptez d'être recontacté par nos équipes.
                </p>
